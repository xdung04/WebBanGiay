                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form id="categoryForm" role="form" action="addcategory" method="GET" onsubmit="return validateForm();">
        ...
        <script>
            function validateForm() {
                ...
                if (categoryName.length > 50) {
                    alert("Hãy nhập ít hơn 50 kí tự.");
                    return false;
                }
                if (specialCharPattern.test(categoryName)) {
                    alert("Không được để kí tự đặc biệt.");
                    return false;
                }
                return true;
            }
